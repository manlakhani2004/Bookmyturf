...
// import { Logout } from '../../services/operations/auth'; // adjust path if needed
...
const Sidebar = ({ sidebarOpen, setSidebarOpen, currentPage, setCurrentPage }) => {
  ...
  return (
    <aside
      ...
      } bg-gray-800/80 backdrop-blur-lg border-r border-gray-700 transition-all duration-300 flex flex-col`}
    >
      {/* HEADER */}
      ...
      <div className="border-t border-gray-700 p-4 space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center px-4 py-2 text-gray-300 hover:text-white hover:bg-gray-700/50 transition-all duration-200 rounded-lg"
        >
